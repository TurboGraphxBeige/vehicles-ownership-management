...
INSERT INTO role (role_id, role_name) VALUES (uuidv4(), 'admin');
...
WHERE model_name = 'Prius C'
  AND brand_id = (SELECT brand_id FROM brand_upsert LIMIT 1)
    ...
    ins_model AS (
INSERT INTO model (model_id, brand_id, model_name)
...
INSERT INTO vehicle (vehicle_id, model_id, making_year, purchase_date)
...
-- SELECT * FROM brand WHERE brand_name = 'Toyota';
-- SELECT * FROM model WHERE model_name = 'Prius C' AND brand_id = (SELECT brand_id FROM brand WHERE brand_name = 'Toyota');
-- SELECT * FROM vehicle WHERE model_id = (SELECT model_id FROM model WHERE model_name = 'Prius C' AND brand_id = (SELECT brand_id FROM brand WHERE brand_name = 'Toyota')) AND making_year = 2015 AND purchase_date = '2020-08-01';